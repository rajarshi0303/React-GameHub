...
export default function SignIn() {
  ...
  function handlePassword(event) {
    ...
    setFormdata((prevformdata) => ({ ...prevformdata, password: password }));
  ...
  function handleSubmit(event) {
    ...
    if (formdata.email === "") {
      ...
      // Clear error messages if submission is successful
      setEmailErrorMessage("");
      setPasswordErrorMessage("");
      setLoaing(true);
      axios
        .get(`http://localhost:3000/users?email=${formdata.email}`)
        .then((response) => {
          console.log(response.data);
  ...
  return (
    <div>
      <section
        ...
        style={{
          backgroundImage: "url('/public/images/design/login_bg.jpg')",
        }}
      >
            ...
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
              ...
              <div className="mt-8 lg:w-1/2 lg:mx-6">
                ...
                >
                  ...
                  <a
                    onClick={login}
                    className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg cursor-pointer dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
                  >
                  ...
                  <div className="flex items-center justify-center mt-4">
                    <NavLink to="/signup">
                      <div className="text-base font-semibold text-gray-500 capitalize dark:text-gray-400 hover:text-gray-800">
                        ...
                        <span className="text-amber-600">SignUp</span>
                      </div>
                    </NavLink>
                  </div>
                </motion.div>
